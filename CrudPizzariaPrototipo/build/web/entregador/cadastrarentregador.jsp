<%-- 
    Document   : cadastrarentregador
    Created on : 23/10/2018, 01:28:59
                        ...
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3">
                            ...
                            <section id="services" >
                                <div class="container">  
                                    ...
                                    <div class="features">
                                        <form name="cadastrarentregador" action="CadastrarEntregador" method="POST">                                              
                                            <div class="control-group">
                                                <div class="controls">
                                                    <div class="form-group left-inner-addon">                                                   
                                                        <input type="text" name="nomeEntregador" class="form-control" placeholder="Nome">
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class="controls">
