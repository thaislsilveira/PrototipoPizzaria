<%-- 
    Document   : produto
    Created on : 27/10/2018, 19:14:24
        ...
        <div class="col-md-10">
            <section id="services" >
                <div class="container">                   
                    <div class="row">
                        <div class="col-md-8">
                            <h3 style="margin-left: 200px;">Produtos</h3>
                            <br/>
                            <div class="features">
                                <a style="margin-left: 50px;" href="ListarProduto"> Lista de Produtos</a>
                                <a  style="margin-left: 200px;" href="cadastrarProduto.jsp"> Cadastro de Produtos</a>
                            </div>
                        </div>
                    </div><!--/.row-->    
                </div><!--/.container-->
