                                                            ...
                                                            <div class="col-md-12 form-group ">  
                                                                ...
                                                                <select class="form-control" name="idCliente" id="idCliente" style=" height: 40px;">
                                                                    <c:forEach var="cliente" items="${clientes}">
                                                                        <option value="${cliente.idCliente}"${cliente.idCliente == cliente.idCliente ? ' selected' : ''}>${cliente.nomeCliente}</option>
                                                                    </c:forEach>
                                                                </select>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" name="tipoPedido" id="tipoPedido" style=" height: 40px;">
                                                                        <option value="1"${pedido.tipoPedido == 1 ?' selected' : ''}>Interno</option>
                                                                        <option value="2"${pedido.tipoPedido == 2 ?' selected' : ''}>Externo</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                            ...
                                                                            <div class="form-group"> 
                                                                                ...
                                                                                <select class="form-control" name="idMesa" id="idMesa" style=" height: 40px;">
                                                                                    <%
                                                                                        ...
                                                                                        for (Mesa mesa : mesas) {
                                                                                    %>               
                                                                                    <option value="<%= mesa.getIdMesa()%>"<%=(((Pedido) request.getAttribute("pedido")).getMesa().getIdMesa()) == mesa.getIdMesa() ? "selected" : ""%>><%= mesa.getIdMesa()%></option>                    
                                                                                    <% }%>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-12 form-group ">  
                                                                            ...
                                                                            <select class="form-control" name="idFuncionario" id="idFuncionario" style=" height: 40px;">
                                                                                <c:forEach var="funcionario" items="${funcionarios}">
                                                                                    <option value="${funcionario.idFuncionario}"${pedido.funcionario.idFuncionario == funcionario.idFuncionario ? ' selected' : ''}>${funcionario.nomeFuncionario}</option>
                                                                                </c:forEach>
                                                                            </select>
                                                                        </div>
                                                                    </div>  
                                                                        ...
                                                                        <div class="col-md-12 form-group ">  
                                                                            ...
                                                                            <select class="form-control" name="idEntregador" id="idEntregador" style=" height: 40px;">
                                                                                <c:forEach var="entregador" items="${entregadores}">
                                                                                    <option value="${entregador.idEntregador}"${pedido.entregador.idEntregador == entregador.idEntregador ? ' selected' : ''}>${entregador.nomeEntregador}</option>
                                                                                </c:forEach>
                                                                            </select>
                                                                        </div>
                                                                    </div>  
