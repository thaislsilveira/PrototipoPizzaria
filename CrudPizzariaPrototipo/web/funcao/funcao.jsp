<%-- 
    Document   : funcao
    Created on : 08/11/2018, 08:27:10
    Author     : PC 05
--%>
        ...
        <div class="col-md-10">
            <section id="services" >
                <div class="container">                   
                    <div class="row">
                        <div class="col-md-8">
                            <h3 style="margin-left: 200px;">Função</h3>
                            <br/>
                            <div class="features">
                                <a style="margin-left: 50px;" href="ListarFuncao"> Lista de Função</a>
                                <a  style="margin-left: 200px;" href="cadastrarFuncao.jsp"> Cadastro de Função</a>
                            </div>
                        </div>
                    </div><!--/.row-->    
                </div><!--/.container-->
